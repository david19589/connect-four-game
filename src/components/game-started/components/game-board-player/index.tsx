      ...
      if (!board[rowIndex][colIndex]) {
        ...
        if (checkWin(newBoard, rowIndex, colIndex, props.currentPlayer)) {
          ...
          props.setCurrentPlayer(
            props.currentPlayer === "red" ? "yellow" : "red"
          );
        ...
        row.map((cell, colIndex: number) => (
          <div
            ...
            className={clsx(
              ...
              !cell && "bg-[#7945FF]",
              "md:w-16 md:h-16 w-6 h-6 sm:w-9 sm:h-9 border-[0.3rem] border-[#000] shadow-custom-shadow-2 rounded-full cursor-pointer"
            )}
          />
        ))
      )}
